...
from test_maint_ch42 import COVERED as COVERED_MAINT_42
...
ALL_COVERED = COVERED_24 | COVERED_42 | COVERED_FIM_42 | COVERED_MAINT_42 | COVERED_QRH_42
...
def test_chapter_suites_do_not_overlap() -> None:
    ...
    assert not (COVERED_24 & COVERED_FIM_42)
    assert not (COVERED_42 & COVERED_FIM_42)
    assert not (COVERED_FIM_42 & COVERED_MAINT_42)
